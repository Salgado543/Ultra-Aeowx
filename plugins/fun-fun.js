...
if (['weco','gay','lesbiana','pajero','pajera','puto','puta','manco','manca','rata','prostituto','prostituta'].includes(command)) {
...
handler.help = ['top', 'sorteo', 'ship', 'shippear', 'afk', 'personalidad', 'formarpareja', 'gay', 'weco', 'lesbiana', 'pajero', 'pajera', 'puto', 'puta', 'manco', 'manca', 'rata', 'prostituto', 'prostituta', 'doxear', 'doxeo', 'doxxeo']
handler.tags = ['fun']
