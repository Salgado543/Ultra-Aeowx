...
if (['cachonda','lesbiana','pajero','pajera','puto','puta','manco','manca','rata','prostituto','prostituta'].includes(command)) {
...
case 'cachonda':
emoji = '🔥'
description = percentages < 50 ? `💙 Los cálculos han arrojado que ${userId} es *${percentages}%* Cachonda ${emoji}\n> ✰ Eso es bajo, ¡Tú eres Cachondisima, hoy sí!` : percentages > 100 ? `💜😏 Los cálculos han arrojado que ${userId} es *${percentages}%* Cachonda ${emoji}\n> ✰ ¡Incluso más Cachonda de lo que pensábamos!` : `🖤😱 Los cálculos han arrojado que ${userId} es *${percentages}%* Cachonda ${emoji}\n> ✰ Lo tuyo, lo tuyo es que eres Cachondisima.`
break
case 'lesbiana':
emoji = '🏳️‍🌈'
